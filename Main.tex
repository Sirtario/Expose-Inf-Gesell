...
\glqq 1. Es muss gewährleistet sein, dass die Entwicklung, Einführung und Nutzung von KI-Systemen die Anforderungen an vertrauenswürdige KI erfüllen:
...
Diese Verzerrungen können dabei Stichprobenverzerrungen, Messwertverzerrungen, Kennzeichnungsverzerrungen, oder Verzerrung durch Einseitigkeit beinhalten. \cite{Srinivasan}
...
Es kann auch vorkommen, dass Daten falsch, überflüssig oder unzuverlässig gekennzeichnet werden. Bespielsweise ist die Unterscheidung zwischen einer \textit{Wiese} und einer \textit{Weide} selten nötig. Existieren aber beide Label im Trainingsdatensatz einer KI kann sich dies negativ auf die Genauigkeit des Modells auswirken, wenn bei der Beschriftung nicht konsequent beide Begriffe unterschieden werden. \cite{Srinivasan}
...
\begin{itemize}
    ...
    \item Quantität: Die Anzahl der Daten muss ausreichen um diese Realitätswiederspiegelung gewährleisten zu können.
...
Bei den Definitionen der Anforderungen eines Modell kann es zu Verzerrungen kommen.

Diese Verzerrung kann einerseits durch die Formulierung der Aufgabenstellung aus den Anforderungen entstehen, oder durch die Art der verwendeten Daten um das Ergebnis des Models zu erhalten.
Ein Problem bei der Formulierung der Anforderungen an einen Algorithmus kann beispielsweise sein, bei einer Prüfrung auf Kreditwürdigkeit eines möglichen Kreditnehmers Daten wie Geschlecht, Hautfarbe oder ethnische Zugehörigkeit in den Entscheidungsprozess einfließen zu lassen. Hierdurch können sexistische oder rassistische Diskriminierungen bei der Entscheidung stattfinden. \cite{Srinivasan}

Hier empfiehlt sich das Einsetzten eines neutralen Beobachters, welcher die Anforderungen und daraus enstehende Aufgabenstellung auf folgende Aspekte prüft: 
\begin{itemize}
    ...
    \item Die Formulierung muss neutral gestaltet sein, das heißt durch die Formulierung an sich dürfen siche keine voreingenommenen Schlüsse ziehen lassen.
\end{itemize}

\subsubsection{Verzerrungen bei der Modellbewertung}
...
Menschliche Bewerter eines Modells können in veschiedenen Aspekten kritisch handeln. Sie können durch eigene Einstellungen und Erfahrungen, auch unabsichtlich, beeinflußt sein.
Gerade wenn ein Bewerter direkt am Model beteiligt ist kann es zum so genannten Bestätigungsfehler, oder \glqq Peak-End-Effect\grqq{} kommen.
Ein Bestätigungsfehler ist die Neigung durch subjektive Wahrnemung, eine Erwartung bestätigt zu sehen. Ist so beispielsweise der Beurteiler beruflich oder finanziell direkt vom Erfolg des Projekts abhängig ist es schnell möglich, dass Fehler nicht auffallen oder relativiert werden.
...
\subsubsection{Datenerweiterung (Data Augmentation)}
...
\subsubsection{Verstärktes Lernen (Reinforcement Learning)}
...
\subsubsection{Kontradiktorisches Lernen (Adversarial Learning)}
