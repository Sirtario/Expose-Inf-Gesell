...
Im Folgenden wird ein kurzer Abriss gegeben, welche internationale Vorgaben zu ethischen Aspekten von KI in dieser Arbeit angewandt werden, um zu definieren, was "Ethik" in Bezug auf KI bedeutet, und welche Fachtermini aus der Thematik bildgenerierende KI in der vorliegenden Arbeit wie verwendet werden.
\section{Ethik}\label{def_ai}

\paragraph{EU\cite{EUCommision}\\}
Im April 2019 veröffentlichte die Kommission der Europäischen Union Empfehlungen zur Umsetzung ethischer KI \cite{EUCommision}.
