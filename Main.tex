...
\paragraph{Werte:}
\begin{itemize}
	\item Achtung, Schutz und Förderung der Menschenrechte, grundlegender Freiheiten und der menschlichen Würde.
	\item Förderung einer blühenden Umwelt und Ökosystems.
	\item Gewährleistung von Vielfalt und Inklusion.
	\item Leben in friedlichen, gerechten und vernetzten Gesellschaften.
\end{itemize}
